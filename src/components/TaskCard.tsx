      ...
      <div className="flex items-start justify-between">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-white rounded-xl shadow-clay p-2 min-w-[220px]">
            <DropdownMenuItem className="rounded-lg hover:bg-clay-yellow cursor-pointer" onClick={() => onStatusChange(task.id, "pendente")}>
              Marcar como Pendente
            </DropdownMenuItem>
            <DropdownMenuItem className="rounded-lg hover:bg-clay-orange cursor-pointer" onClick={() => onStatusChange(task.id, "em-andamento")}>
              Marcar Em Andamento
            </DropdownMenuItem>
            <DropdownMenuItem className="rounded-lg hover:bg-clay-mint cursor-pointer" onClick={() => onStatusChange(task.id, "concluída")}>
