      ...
      <DialogContent className="bg-white rounded-2xl shadow-clay border-none">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          <div className="space-y-2">
            ...
            <Input id="discipline-name" placeholder="Digite o nome da disciplina" className="clay-input" value={disciplineName} onChange={e => setDisciplineName(e.target.value)} required />
          </div>
          <div className="flex justify-end gap-2 mt-4">
            <Button type="button" variant="outline" className="clay-button bg-secondary" onClick={() => setDialogOpen(false)}>
              Cancelar
            </Button>
            <Button type="submit" className="clay-button bg-primary text-primary-foreground">
              Adicionar
            </Button>
          </div>
        </form>
